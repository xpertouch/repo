...
public  Products(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myBucketRV = (RecyclerView) v.findViewById(R.id.myProductsBucket);
        myBucketRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        myBucketRV.clearOnScrollListeners();
        myBucketRV.hasFixedSize();

        loadProgress = (RelativeLayout) v.findViewById(R.id.prodcutsBucketProgress);
        noAdverts  =  (LinearLayout) v.findViewById(R.id.noProductsBucket);
